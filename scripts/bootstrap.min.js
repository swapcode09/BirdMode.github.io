...
!function(e, t) {
            ...
            return r(e, [{
                ...
                value: function() {
                    ...
                    if ("undefined" != typeof Promise) {
                        ...
                        o.default)(document, this.options.linkSelector, "click", this.linkClickHandler.bind(this)),
                        window.addEventListener("popstate", this.boundPopStateHandler);
                        var t = (0,
                        v.getDataFromHtml)(document.documentElement.outerHTML, this.options.containers);
                        t.url = t.responseURL = (0,
                        v.getCurrentUrl)(),
                        this.options.cache && this.cache.cacheUrl(t),
                        (0,
                        v.markSwupElements)(document.documentElement, this.options.containers),
                ...
                value: function() {
                    ...
                    (0,
                    g.queryAll)("[data-swup]").forEach(function(e) {
                ...
                value: function(e) {
                    if (e.metaKey || e.ctrlKey || e.shiftKey || e.altKey)
                        ...
                        if (t.getAddress() == (0,
                        v.getCurrentUrl)() || "" == t.getAddress())
                            "" != t.getHash() ? (this.triggerEvent("samePageWithHash", e),
                            null != document.querySelector(t.getHash()) ? history.replaceState({
    ...
    , function(e, t, n) {
        ...
        t.default = function(e, t) {
            ...
            null != e.customTransition ? (this.updateTransition(window.location.pathname, e.url, e.customTransition),
            document.documentElement.classList.add("to-" + (0,
            r.classify)(e.customTransition))) : this.updateTransition(window.location.pathname, e.url),
            !t || this.options.animateHistoryBrowsing ? function() {
                ...
                !t) {
                    ...
                    (0,
                    r.createHistoryRecord)(i)
                }
            }() : this.triggerEvent("animationSkipped"),
            this.cache.exists(e.url) ? (a = new Promise(function(e) {
                e()
            }
            ),
            this.triggerEvent("pageRetrievedFromCache")) : a = this.preloadPromise && this.preloadPromise.route == e.url ? this.preloadPromise : new Promise(function(t, o) {
                ...
                r.fetch)(i({}, e, {
                    ...
                    if (500 === i.status)
                        return n.triggerEvent("serverError"),
                        void o(e.url);
    ...
    , function(e, t, n) {
        ...
        t.default = function(e, t) {
            ...
            for (var o = [], a = function(e) {
                if (null == n.querySelector(t[e]))
                    return {
                        v: null
                    };
                (0,
                r.queryAll)(t[e]).forEach(function(i, a) {
                    (0,
                    r.queryAll)(t[e], n)[a].setAttribute("data-swup", o.length),
                    o.push((0,
                    r.queryAll)(t[e], n)[a].outerHTML)
                })
            }, s = 0; s < t.length; s++) {
                var u = a(s);
                if ("object" === (void 0 === u ? "undefined" : i(u)))
                    return u.v
            }
            var l = {
    ...
    , function(e, t, n) {
        ...
        t.default = function(e, t) {
            for (var n = 0, r = function(r) {
                null == e.querySelector(t[r]) ? console.warn("Element " + t[r] + " is not in current page.") : (0,
                i.queryAll)(t[r]).forEach(function(o, a) {
                    (0,
                    i.queryAll)(t[r], e)[a].setAttribute("data-swup", n),
                    n++
                })
            }, o = 0; o < t.length; o++)
                r(o)
        ...
        var i = function() {
          ...
          , r = function() {
            function e(t) {
                ...
                t instanceof Element || t instanceof SVGElement ? this.link = t : (this.link = document.createElement("a"),
                this.link.href = t)
            }
            return i(e, [{
                key: "getPath",
                ...
                value: function() {
                    ...
                    return this.link.getAttribute("xlink:href") && (e = this.link.getAttribute("xlink:href")),
                    "/" !== e[0] && (e = "/" + e),
                    e
                }
            }, {
    ...
    , function(e, t, n) {
        ...
        t.default = function() {
            var e = [];
            return (0,
            i.queryAll)(this.options.animationSelector).forEach(function(t) {
                var n = new Promise(function(e) {
                    t.addEventListener((0,
                    r.transitionEnd)(), function(n) {
                        t == n.target && e()
                    })
                }
                );
    ...
    , function(e, t, n) {
        ...
        t.default = function(e) {
            var t = e.responseText
              , n = (0,
            i.getDataFromHtml)(t, this.options.containers);
            return n ? (n.responseURL = e.responseURL ? e.responseURL : window.location.href,
            n) : (console.warn("The link you are hovering over does not exist (404 ERROR) Please make sure your link is pointing to a valid location."),
            null)
        }
    }
    , function(e, t, n) {
        ...
        t.unuse = function(e) {
            ...
            if (t = "string" == typeof e ? this.plugins.find(function(t) {
                ...
                return this.plugins.splice(n, 1),
                this.plugins
            }
...
(function e(t, r) {
    if (typeof exports === "object" && typeof module === "object")
        ...
        exports["SwupPreloadPlugin"] = r();
    else
        t["SwupPreloadPlugin"] = r()
}
)(window, function() {
    return function(e) {
        var t = {};
    ...
    , function(e, t, r) {
        ...
        var v = function(e) {
            ...
            function t() {
                ...
                return o = (r = (n = d(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(u))),
                n),
                ...
                n.onMouseover = function(e) {
                    ...
                    if (r.getAddress() !== (0,
                    f.getCurrentUrl)() && !t.cache.exists(r.getAddress()) && t.preloadPromise == null) {
                ...
                n.preloadPage = function(e) {
                    ...
                    return new Promise(function(e, n) {
                        if (r.getAddress() != (0,
                        f.getCurrentUrl)() && !t.cache.exists(r.getAddress())) {
                            (0,
                            f.fetch)({
                                url: r.getAddress(),
                ...
                n.preloadPages = function() {
                    (0,
                    l.queryAll)("[data-swup-preload]").forEach(function(e) {
            ...
            n(t, [{
                ...
                value: function e() {
                    ...
                    t.delegatedListeners.mouseover = (0,
                    i.default)(document.body, t.options.linkSelector, "mouseover", this.onMouseover.bind(this));
                    t.preloadPages();
        ...
        var a = function e(t, r) {
            ...
            var l = function e(t) {
                if (u.querySelector(r[t]) == null) {
                    ...
                    (0,
                    o.queryAll)(r[t]).forEach(function(e, n) {
                        (0,
                        o.queryAll)(r[t], u)[n].dataset.swup = i.length;
                        i.push((0,
                        o.queryAll)(r[t], u)[n].outerHTML)
                    })
                }
            };
        ...
        var o = function e(t, r) {
            ...
            var a = function e(a) {
                if (t.querySelector(r[a]) == null) {
                    ...
                    (0,
                    n.queryAll)(r[a]).forEach(function(e, u) {
                        (0,
                        n.queryAll)(r[a], t)[u].dataset.swup = o;
                        o++
                    })
                }
            };
